...
const Testimonials = () => {
	...
	return <Slider {...settings}>
		<div className="testimonial px-4 py-3">
			<p>
			...
			<div className="d-flex align-items-center gap-4 mt-3">
				...
				<div>
					<h6 className="mb-0 mt-3">Smith Williams</h6>
					<p>Customer</p>
				</div>
			</div>
		</div>
		<div className="testimonial px-4 py-3">
			...
			<div className="d-flex align-items-center gap-4 mt-3">
				...
				<div>
					<h6 className="mb-0 mt-3">Jennifer Winget</h6>
					<p>Customer</p>
				</div>
			</div>
		</div>
		<div className="testimonial px-4 py-3">
			...
			<div className="d-flex align-items-center gap-4 mt-3">
				...
				<div>
					<h6 className="mb-0 mt-3">Robert Collen</h6>
					<p>Customer</p>
				</div>
			</div>
		</div>
		<div className="testimonial px-4 py-3">
			...
			<div className="d-flex align-items-center gap-4 mt-3">
				<img src={ava02} className="w-25 h-25 rounded-2" alt="" />
				<div>
					<h6 className="mb-0 mt-3">Lisa Winget</h6>
					<p>Customer</p>
				</div>
			</div>
		</div>
